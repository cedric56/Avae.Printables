...
namespace Avae.Printables
{
    public partial class PrintingService : IPrintingService
    {
        ...
        public static partial void Invoke(string script);
        ...
        private void Show(string base64, string mime)
        {
            var script = $@"function print(base64Data, mime) {{
        ...
        {
            string? base64 = null;
            string? mime = GetMimeType(Path.GetExtension(file));
